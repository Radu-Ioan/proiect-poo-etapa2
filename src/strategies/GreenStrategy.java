...
public class GreenStrategy implements EnergyChoiceStrategy {
    private PriorityQueue<Producer> queue = new PriorityQueue<>((o1, o2) -> {
        boolean firstProducerIsRenewable = o1.getEnergyType().isRenewable();
        boolean secondProducerIsRenewable = o2.getEnergyType().isRenewable();

        if ((firstProducerIsRenewable && secondProducerIsRenewable)
                || (!firstProducerIsRenewable && !secondProducerIsRenewable)) {
            ...
            return firstProducerIsRenewable ? -1 : 1;
        }
    });
     ...
     */
    @Override
    public List<Producer> producers(final List<Producer> producers,
